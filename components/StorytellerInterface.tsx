...
import {
  refineScenarioForStorytellingWithGroq,
  getStorytellerEvaluationWithGroq
...
interface StorytellerInterfaceProps {
  ...
  grokApiKey?: string | string[]; // Groq API key(s) for storytelling
}
...
const StorytellerInterface: React.FC<StorytellerInterfaceProps> = ({
  ...
  const handleScenarioSubmit = async () => {
    ...
    try {
      console.log("🤖 Using Grok for storytelling scenario refinement...");
      const refined = await refineScenarioForStorytellingWithGroq(grokApiKey, userScenario);
  ...
  const handleStorytellingSubmit = async () => {
    ...
    try {
      ...
      const storytellerFeedback = await getStorytellerEvaluationWithGroq(
        grokApiKey,
        promptForEval,
        userStory,
      );
              ...
              {feedback.storytellingAnalysis && (
                <div className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-lg hover:shadow-white/5">
                  ...
                  <div className="space-y-4">
                    ...
                    {feedback.storytellingAnalysis.sensoryDetails && (
                      <div>
                        <h4 className="font-medium text-white mb-2">
                    ...
                    {feedback.storytellingAnalysis.conflictAnalysis && (
                      <div>
                        <h4 className="font-medium text-white mb-2">
                    ...
                    {feedback.storytellingAnalysis.themeAndSubtext && (
                      <div>
                        <h4 className="font-medium text-white mb-2">
                          Theme & Subtext Identification:
                        </h4>
                        <p className="text-gray-300">
                          {feedback.storytellingAnalysis.themeAndSubtext}
                        </p>
