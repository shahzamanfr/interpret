...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className={`relative border-t transition-colors duration-700 ${theme === "dark"
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <img
                src="/logo.png"
                alt="Interpret Logo"
                className={`h-20 w-auto object-contain transition-all duration-500 hover:scale-110 ${theme === "dark"
                  ? "invert hue-rotate-180 brightness-[1.1]"
          ...
          <div className="space-y-4">
            ...
            <ul
              className={`space-y-2 text-base ${theme === "dark" ? "text-gray-400" : "text-gray-600"
                }`}
            >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start space-x-3">
              <div
                className={`mt-1 p-2.5 rounded-lg ${theme === "dark" ? "bg-gray-800" : "bg-gray-100"
                  }`}
              >
                <svg
              ...
              <div className="space-y-0.5">
                ...
                <a
                  ...
                  className={`text-base transition-colors duration-200 hover:underline ${theme === "dark"
        ...
        {/* Bottom Section */}
        <div
          className={`mt-10 pt-8 border-t ${theme === "dark" ? "border-gray-800" : "border-gray-200"
            }`}
        >
